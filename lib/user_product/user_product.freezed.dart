...
class _$UserProductImpl with DiagnosticableTreeMixin implements _UserProduct {
  const _$UserProductImpl({this.id, required this.inUse});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserProduct(id: $id, inUse: $inUse)';
  }
...
abstract class _UserProduct implements UserProduct {
  const factory _UserProduct({final int? id, required final int inUse}) =
      _$UserProductImpl;
